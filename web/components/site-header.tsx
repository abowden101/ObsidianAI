...
export function SiteHeader() {
  return (
    <motion.header
      ...
      className="fixed top-0 z-50 w-full border-b border-zinc-800/80 bg-black/55 shadow-[0_8px_32px_-12px_rgba(0,0,0,0.9)] backdrop-blur-xl backdrop-saturate-150"
    >
